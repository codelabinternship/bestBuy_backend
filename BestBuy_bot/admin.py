...
from django.contrib import admin
from .models import User, Orders, OrderItem, Product, Category, ChannelPosts, LoyaltyProgram, UserActivityLogs, DeliveryMethods, Promocodes, Branches, PaymentMethods, Variations, BotConfiguration, SMSCampaigns, Reviews, ExportHistory
